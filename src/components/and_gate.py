...
class ANDGate(Component):
    def __init__(self, position, size=(120, 80), 
        ...
        self.on_color = on_color    # Light yellow when on
        self.text_color = text_color
        self.window_size = window_size
        self.shader_manager = shader_manager
        self.input_buttons = input_buttons or []  # Lista de botões de entrada
        
        print(f"[ANDGate] Created with off_color: {self.off_color}, on_color: {self.on_color}")
        ...
        self.vao_name = f"and_gate_{id(self)}"
        self.text_vao_name = f"and_gate_text_{id(self)}"
    ...
    def _initialize(self):
        ...
        try:
            ...
            print(f"[ANDGate] Erro ao carregar shaders: {e}")
            self.shader_ok = False
            return
    ...
    def _create_text_texture(self):
        ...
        text_surface = font.render("AND", True, self.text_color)
    ...
    def _render(self, renderer):
        ...
        try:
            ...
            print(f"[ANDGate] Erro na renderização: {e}")
    ...
    def _calculate_and_result(self):
        """Calcula o resultado da operação AND baseado nos estados dos botões de entrada."""
        if not self.input_buttons:
            return False
        
        # Verificar se todos os botões estão ativos (True)
    ...
    def get_result(self):
        """Retorna o resultado atual da porta AND."""
        return self._calculate_and_result()
